...
class ConvTransBlock(nn.Module):
    def __init__(self, conv_dim, trans_dim, head_dim, window_size, drop_path, type='W', input_resolution=None):
        ...
        if self.input_resolution <= self.window_size:
            self.type = 'W'
        print(self.trans_dim, self.trans_dim, self.head_dim, self.window_size, self.drop_path, self.type, self.input_resolution)
...
class SCUNet(nn.Module):
    ...
    def __init__(self, in_nc=4, config=[2,2,2,2,2,2,2], dim=64, drop_path_rate=0.0, input_resolution=256):
...
if __name__ == '__main__':
    ...
    model = SCUNet(in_nc=4, config=[2, 2, 2, 2, 2, 2, 2], dim=64)
